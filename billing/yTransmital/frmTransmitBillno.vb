Public Class frmTransmitBillno
    ...
    Private Sub frmTransmitBillno_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
        If (e.KeyCode = Keys.Enter) Then
            If txtBillnum.Text = "" Then
                MsgBox("Please Enter BILL number.", vbExclamation, Title:="Message")
            ElseIf txtService.Text = "" Then
                MsgBox("Please Enter Service Rendered/Particulars.", vbExclamation, Title:="Message")
            Else
                ViewYTrans()
                additemTransmittal()
                ViewYTrans()
    ...
    Private Sub frmTransmitBillno_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Me.KeyPreview = True
    End Sub
End Class