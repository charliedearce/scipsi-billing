Public Class frmWalkin1
    Protected Overrides ReadOnly Property CreateParams() As System.Windows.Forms.CreateParams
        ...
        End Get
    End Property
    Private Sub frmWalkin1_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
        If (e.KeyCode = Keys.Enter) Then
            If txtSearch.Text = "" Then
                frmor.txtNotice.Text = "Please enter Customer name."
            Else
                frmor.lblAccname.Text = txtSearch.Text
                txtSearch.Text = ""
            End If
    ...
    Private Sub frmWalkin1_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Me.KeyPreview = True
    End Sub
